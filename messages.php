	...
	<div class="col-sm-6">
				...
				if ($u_id == "new") {
					echo '
						<form>
							...
							<input type="submit" class="btn btn-default" disabled value="Send"></input>
						</form><br><br>
					';
				}
				else{
					...
					<form action="" method="POST">
						<textarea class="form-control" placeholder="Enter your message" name="msg_box" id="message_txtarea"></textarea>
						<input type="submit" name="send_msg" id="btn-msg" value="Send"></input>
						</form><br><br>
						';
				}
			}
		...
		<?php 
			if (isset($_POST['send_msg'])) {
				...
				if ($msg =="") {
					echo "<h4 style='color:red; tex-align: center'>Message was unable to send!</h4>";
				}
				else if (strlen($msg) >50) {
					echo "<h4 style='color:red; tex-align: center'>Message too long! Use less than 30 characters</h4>";
				}
				else{
			...
			<center>
				<div style='background-color: #e6e6e6;' class='col-sm-9'>
					...
					<ul class='list-group'>
						...
						<li class='list-group-item' title='County'>$user_county</li>

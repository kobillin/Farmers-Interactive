	...
	while($row_posts = mysqli_fetch_array($run_posts)){
		...
		if($content=="No" && strlen($upload_image) >= 1){
			...
			<div class='row'>
				...
				<div style='border: 5px solid #e6e6e6; padding-left: 10px;
		padding-top: 20px;
		padding-right: 2px;
		padding-bottom: 0px;
		' id='posts' class='col-sm-6'>
					<div class='row'>
						<div class='col-sm-2'>
						<p><img src='users/$user_image' class='img-circle' width='100px' height='100px'></p>
						</div>
  ...
  function user_posts(){
  	...
  	while ($row_posts = mysqli_fetch_array($run_posts)) {
  		...
  		if ($u_email !=$user_email) {
  			echo "<script>window.open('my_post.php?u_id', '_self')</script>";
  		}else{
  			if($content=="No" && strlen($upload_image) >= 1){
			echo"
			<div class='row'>
			...
			<div class='row'>
				...
				<div id='posts'style='padding-left:10px; padding-right:10px;' class='col-sm-6'>
					<div class='row'>
						<div class='col-sm-2'>
						<p><img src='users/$user_image' class='img-circle' width='100px' height='100px'></p>
						</div>
						<div class='col-sm-6'>
							<h3><a style='text-decoration:none; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
							<h4><small style='color:black;'>Updated1 a post on <strong>$post_date</strong></small></h4>
						</div>
						<div class='col-sm-4'>
						</div>
					</div>

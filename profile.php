...
<div class="row">
	...
	<div class="col-sm-2" style="background-color: #e6e6e6;text-align: center;left: 0.8%;border-radius: 5px;">
		...
		echo"
			...
			<p><strong>Lives In: </strong> $user_county</p><br>
			 		...
			 		if($content =="No" && strlen($upload_image) >= 1) {
			 			...
			 			<div id='own_posts'>
							...
							<h4><small style='color:black;'>Updated a post on <strong>$post_date</strong></small></h4>
			 				...
			 				<a href='functions/delete_post.php?post_id=$posts_id' style='float:right;'><button class='btn btn-danger'>Delete</button>
			 			</div><br><br>
			 			";
			 		}
			 			...
			 			<div id='own_posts'>
			 				<div class='row'>
			 					<div class='col-sm-2'>
			 						<p><img src='users/$user_image' class='img-circle' width='100px' height='100px' sty></p>
			 					</div>
			 					<div class='col-sm-6'>
	                                    <h3><a style='text-decoration:none; cursor:pointer;color #3897f0;' href='user_profile.php?u_id=$user_id'>$user_name</a></h3>
								<h4><small style='color:black;'>Updated a post on <strong>$post_date</strong></small></h4>

	...
	<div class="col-sm-8">
		<form action="" method="post" enctype="multipart/form-data">
			<table class="table table-bordered table-hover">
				...
				<tr>
					<td style="font-weight: bold;"> Change Your Full Names</td>
					<td>
				...
				<tr>
					...
					<td>
						<select class="form-control" name="u_county">
							<option><?php echo $user_county?></option>
							<option>Bungoma</option>
							<option>Uasingishu</option>
...
<?php
	...
	$u_county = htmlentities($_POST['u_county']);
	$u_gender = htmlentities($_POST['u_gender']);
	$u_birthday = htmlentities($_POST['u_birthday']);

	$update = "update users set f_name='$f_name',l_name='$l_name',user_name='$u_name',describe_user='$describe_user',Relationship='$Relationship_status',user_pass='$u_pass',user_email='$u_email',user_county='$u_county',user_gender='$u_gender',user_birthday='$u_birthday' where user_id='$user_id'";

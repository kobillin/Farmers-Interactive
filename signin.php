...
<div class="row">
	<div class="col-sm-12">
		<div class="main-content">
			<div class="header">
				<h3 style="text-align: center;"><strong>Login to Farmers Interactive</strong></h3>
			</div>
			<div class="l-part">
				<form action="" method="post">
					...
					<!-- <a style="text-decoration: none; margin-top: 5px; float: right;color: #187FAB;" data-toggle="tooltip" title="Admin signin!" href="admin/index.php">Are you an admin?</a><br><br> -->
				</form>
			</div>
		</div>
	</div>
